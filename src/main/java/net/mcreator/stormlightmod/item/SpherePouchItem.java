...
public class SpherePouchItem extends StormlightModModElements.ModElement {
	@ObjectHolder("stormlight_mod:sphere_pouch")
	public static final Item block = null;
	public SpherePouchItem(StormlightModModElements instance) {
		super(instance, 404);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof SphereCageGUIGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("This bag holds spheres"));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Sphere Pouch");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new SphereCageGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
