...
public class LashingAmount2KeyBinding extends StormlightModModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.stormlight_mod.lashing_amount_2", GLFW.GLFW_KEY_2, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 1) {
			...
			LashingAmplifier2Procedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
