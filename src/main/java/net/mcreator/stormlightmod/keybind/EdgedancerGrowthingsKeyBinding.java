...
public class EdgedancerGrowthingsKeyBinding extends StormlightModModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public EdgedancerGrowthingsKeyBinding(StormlightModModElements instance) {
		super(instance, 389);
	...
	public void initElements() {
		keys = new KeyBinding("key.stormlight_mod.edgedancer_growthings", GLFW.GLFW_KEY_R, "key.categories.misc");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			PressREdgedancerProcedure.executeProcedure(Stream
