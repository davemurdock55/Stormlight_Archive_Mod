...
public class SpherePouchGUIGui extends StormlightModModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public SpherePouchGUIGui(StormlightModModElements instance) {
		super(instance, 405);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("sphere_pouch_gui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("stormlight_mod:textures/sphere_pouch_gui.png");
		@Override
