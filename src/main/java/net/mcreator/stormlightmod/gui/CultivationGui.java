...
public class CultivationGui extends StormlightModModElements.ModElement {
	...
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, CultivationGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			CultivationSprenspawningProcedure.executeProcedure(Stream
