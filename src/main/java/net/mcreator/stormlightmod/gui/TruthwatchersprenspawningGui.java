...
public class TruthwatchersprenspawningGui extends StormlightModModElements.ModElement {
	...
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, TruthwatchersprenspawningGuiWindow::new));
	}
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			TruthwatcherProcedure.executeProcedure(Stream
