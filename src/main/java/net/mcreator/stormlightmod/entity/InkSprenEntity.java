...
import net.mcreator.stormlightmod.entity.renderer.InkSprenRenderer;
...
public class InkSprenEntity extends StormlightModModElements.ModElement {
	...
	public InkSprenEntity(StormlightModModElements instance) {
		super(instance, 379);
		FMLJavaModLoadingContext.get().getModEventBus().register(new InkSprenRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			InkSprenRightClickedProcedure.executeProcedure(
