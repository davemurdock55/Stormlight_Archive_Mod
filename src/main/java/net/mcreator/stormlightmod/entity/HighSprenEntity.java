...
import net.mcreator.stormlightmod.entity.renderer.HighSprenRenderer;
...
public class HighSprenEntity extends StormlightModModElements.ModElement {
	...
	public HighSprenEntity(StormlightModModElements instance) {
		super(instance, 227);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HighSprenRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			HighsprenRightClickedOnEntityProcedure.executeProcedure(
