...
import net.mcreator.stormlightmod.entity.renderer.CultivationSprenRenderer;
...
public class CultivationSprenEntity extends StormlightModModElements.ModElement {
	...
	public CultivationSprenEntity(StormlightModModElements instance) {
		super(instance, 236);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CultivationSprenRenderer.ModelRegisterHandler());
