...
import net.mcreator.stormlightmod.entity.renderer.TruthwatcherSprenRenderer;
...
public class TruthwatcherSprenEntity extends StormlightModModElements.ModElement {
	...
	public TruthwatcherSprenEntity(StormlightModModElements instance) {
		super(instance, 232);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TruthwatcherSprenRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			TruthwatcherSprenrightProcedure.executeProcedure(
