...
import net.mcreator.stormlightmod.entity.renderer.AxehoundRenderer;
...
public class AxehoundEntity extends StormlightModModElements.ModElement {
	...
	public AxehoundEntity(StormlightModModElements instance) {
		super(instance, 393);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AxehoundRenderer.ModelRegisterHandler());
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 10, 4, 7));
	}
