...
public class Truthwatcher1PotionEffect {
	...
	public static class EffectCustom extends Effect {
		...
		public void affectEntity(Entity source, Entity indirectSource, LivingEntity entity, int amplifier, double health) {
			...
			TruthwatcherPotionEffectProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
