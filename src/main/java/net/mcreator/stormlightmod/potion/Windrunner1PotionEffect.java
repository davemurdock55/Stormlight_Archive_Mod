...
public class Windrunner1PotionEffect {
	...
	public static class EffectCustom extends Effect {
		...
		public void affectEntity(Entity source, Entity indirectSource, LivingEntity entity, int amplifier, double health) {
			...
			WindrunnerpotioneffectProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
