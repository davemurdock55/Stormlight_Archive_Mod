...
public class EdgedancerPotionEffectProcedure extends StormlightModModElements.ModElement {
	public EdgedancerPotionEffectProcedure(StormlightModModElements instance) {
		super(instance, 189);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure EdgedancerPotionEffect!");
			return;
		}
