	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				StormlightModMod.LOGGER.warn("Failed to load dependency entity for procedure InkSprenRightClicked!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				StormlightModMod.LOGGER.warn("Failed to load dependency sourceentity for procedure InkSprenRightClicked!");
			return;
		}
		...
		if (((sourceentity instanceof ServerPlayerEntity) && (sourceentity.world instanceof ServerWorld))
			...
			if (!((sourceentity instanceof PlayerEntity)
					? ((PlayerEntity) sourceentity).inventory.hasItemStack(new ItemStack(SprenbladeItem.block))
					: false)
