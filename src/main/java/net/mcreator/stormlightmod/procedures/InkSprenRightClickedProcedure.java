...
public class InkSprenRightClickedProcedure extends StormlightModModElements.ModElement {
	public InkSprenRightClickedProcedure(StormlightModModElements instance) {
		super(instance, 379);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure InkSprenRightClicked!");
			return;
		}
		if (dependencies.get("sourceentity") == null) {
			if (!dependencies.containsKey("sourceentity"))
				System.err.println("Failed to load dependency sourceentity for procedure InkSprenRightClicked!");
			return;
		}
