...
public class OathGateProcedureProcedure extends StormlightModModElements.ModElement {
	public OathGateProcedureProcedure(StormlightModModElements instance) {
		super(instance, 377);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				StormlightModMod.LOGGER.warn("Failed to load dependency entity for procedure OathGateProcedure!");
			return;
		}
