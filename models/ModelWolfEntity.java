...
public static class ModelWolfEntity extends TameableEntity {
	private static final DataParameter<Boolean> BEGGING = EntityDataManager.createKey(WolfEntity.class,
			DataSerializers.BOOLEAN);
	private static final DataParameter<Integer> COLLAR_COLOR = EntityDataManager.createKey(WolfEntity.class,
	...
	public ModelWolfEntity(EntityType<? extends WolfEntity> type, World worldIn) {
		super(type, worldIn);
		this.setTamed(false);
	}
	...
	protected SoundEvent getAmbientSound() {
		if (this.isAngry()) {
			...
			return this.isTamed() && this.getHealth() < 10.0F
	...
	class AvoidEntityGoal<T extends LivingEntity> extends net.minecraft.entity.ai.goal.AvoidEntityGoal<T> {
		...
		public AvoidEntityGoal(WolfEntity wolfIn, Class<T> entityClassToAvoidIn, float avoidDistanceIn,
